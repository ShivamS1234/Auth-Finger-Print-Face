...
extern void *mono_aot_module_SMSFingerprintSampleiOS_info;
...
extern void *mono_aot_module_SMS_Fingerprint_Sample_info;
...
{
	mono_aot_register_module (mono_aot_module_SMSFingerprintSampleiOS_info);
	...
	mono_aot_register_module (mono_aot_module_SMS_Fingerprint_Sample_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "SMSFingerprintSampleiOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
